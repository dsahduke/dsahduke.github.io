...
```{r, echo=FALSE}
instructors <- c("Xiling Shen", "Michael Gao")
emails <- c("xiling.shen@duke.edu", "michael.gao@duke.edu")
role <- c("Professor", "Instructor")
...
### Class Location:
**ONLINE ONLY**
This course will be held online only. DukeHub may list a location for in-person instruction, but please ignore this. You will be able to reacht he zoom link via sakai and a passcode will be provided.
